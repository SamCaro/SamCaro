...
export const ContactForm = () => {
  ...
  return (
    <>
      ...
      <article className='bg-zinc-300 h-20 rounded-bl-[50px] sm:rounded-bl-[70px] sm:h-[300px]'>
        ...
        <form ref={refForm} onSubmit={handleSubmit(onSubmit)} className='bg-white h-[400px] sm:h-[300px] w-[210px] p-4 ml-[100px] text-Roboto shadow-md rounded-sm sm:w-[500px] sm:h-[700px] sm:p-12 sm:ml-[600px] sm:mt-[-250px]'>
  ...
  maxLength: 10,
          ...
          <input className='text-[12px] bg-zinc-300 w-[180px] h-6 rounded-sm sm:mb-12 sm:h-12 sm:w-[400px] hover:text-white hover:shadow-md cursor-pointer' type='submit' value='SEND' />
